            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Reward')
                            <span class="font-weight-bold">{{getAmount($totalReward)}}  {{__($general->cur_text)}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total Balance')
                            <span class="font-weight-bold">{{getAmount($user->balance+$totalReward)}}  {{__($general->cur_text)}}</span>
                        </li>
