            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Status')
                            @if(isset($software->user->status) && $software->user->status == 1)
                                <span class="badge badge-pill bg--success">@lang('Active')</span>
                            @elseif(isset($software->user->status) && $software->user->status == 0)
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 col-sm-12 mt-10">
                ...
                <div class="row mb-30">
                    <div class="col-lg-12">
                        <div class="card border--dark">
                            ...
                            <h5 class="card-header bg--dark">@lang('Picture and Media')</h5>
                            @else 
            ...
            <div class="row mb-30">
                <div class="col-lg-6 mt-2">
                    <div class="card border--dark">
                        <h5 class="card-header bg--dark">@lang('Product Information')</h5>
                        <div class="card-body">
                            <ul class="list-group">
            ...
            <div class="row mb-30">
                <div class="col-lg-12 mt-2">
                    <div class="card border--dark">
                        <h5 class="card-header bg--dark">@lang('Product Verities(Verities in different size and color)')</h5>
                        <div class="card-body">
                            <ul>
                                <li class="list-group-item d-flex justify-content-between align-items-center font-weight-bold">
                                  @lang('Product Name')
