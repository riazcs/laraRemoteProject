                        ...
                        @forelse($softwares as $software)
                            <tr @if($loop->odd) class="table-light" @endif>
                                <td data-label="@lang('Title')">
                                    <div class="user">
                                        <div class="thumb">
                                            <img src="{{ getImage('assets/images/software/'.$software->image,'590x300')}}" alt="@lang('image')">
                                        </div>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="{{route('admin.software.edit', [slug($software->title), $software->id])}}" class="icon-btn ml-2"><i class="fa fa-pencil-alt"></i></a>
                                    <a href="{{route('admin.software.manage', [slug($software->title), $software->id])}}" class="icon-btn ml-2">Manage</a>
                                    <a href="javascript:void(0)" data-id="{{$software->id}}" class="icon-btn ml-2 btn--danger delete"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
...
<div class="modal fade" id="deletepr" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.software.delete')}}" method="POST">
                    @csrf
                    @method('POST')
                    <input type="text" name="id">
                    <div class="modal-body">
                        <p>@lang('Are you sure to delete this Product..?')</p>
                    </div>
...
<div class="form-inline float-sm-right mr-1"><a href="{{ route('admin.software.createadminproduct') }}" class="btn btn--success"><i class="fa fa-plus"></i> Add New</a></div><br>
@endpush

@push('breadcrumb-plugins')
<div class=""><a href="{{ url('get_wp_products') }}" class="btn btn--success"><i class="fa fa-plus"></i> Fetch Wordpress Products</a></div>
<div class=""><a href="{{ url('get_wp_price') }}" class="btn btn--success"><i class="fa fa-plus"></i> Fetch Wordpress Shipping Price</a></div>
@endpush
