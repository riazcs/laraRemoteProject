                                        ...
                                        <table class="table table--light style--two">
                                            ...
                                            <tbody>
                                                @foreach(explode(",",$booking->extra_service) as $value)
                                                    ...
                                                    <tr>
                                                        <td data-label="@lang('Title')">{{__(!empty($extraService) ? $extraService->title : '')}}</td>
                                                        <td data-label="@lang('Price')"><span class="font-weight-bold">{{$general->cur_sym}}{{showAmount(!empty($extraService) ? $extraService->price:0)}}</span></td>
                                                    </tr>
                                                @endforeach 
                                            </tbody>
                                        </table>
