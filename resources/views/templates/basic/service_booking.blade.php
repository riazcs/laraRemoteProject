                                                ...
                                                <div class="service-card-form">
                                                    @foreach($service->extraService as $key => $extra)
                                                        <div class="form-row">
                                                            ...
                                                            <div class="right">
                                                                <span class="value">
                                                                    {{$code['currency']}}{{getAmount($extra->price*$code['rate'])}}
                                    ...
                                    <div class="sidebar">
                                        <div class="widget custom-widget mb-30">
                                            ...
                                            <ul class="details-list">
                                                <li><span>@lang('Service Price') :</span>
                                                    <div class="order-price-tags">
                                                        ...
                                                        <span id="servicePrice">{{getAmount($service->price*$code['rate'])}}</span>
                                                    </div>
                                                </li>
                                                ...
                                                <li><span>@lang('Subtotal') :</span>
                                                    <div class="order-price-tags">
                                                        <span>{{$code['currency']}}</span>
                                                        <span id="totalPrice">{{getAmount($service->price*$code['rate'])}}</span>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="total-price-area d-flex flex-wrap align-items-center justify-content-between">
                                                ...
                                                <div class="right">
                                                    <h4 class="title">{{$code['currency']}}<span id="paymentPrice">{{getAmount($service->price*$code['rate'])}}</span></h4>
                                                </div>
                                            </div>
                                            @if($coupon)
                ...
                $.ajax({
                    ...
                    success:function(response){
                        if(response.error){
                            ...
                            $("#paymentPrice").text(`${parseFloat(final.toFixed(8)*{{ $code['rate'] }})}`);
                        }
                    }
                });
            }
