                                            ...
                                            <nav>
                                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                    ...
                                                    <button class="nav-link" id="software-tab" data-bs-toggle="tab" data-bs-target="#software" type="button"
                                                        role="tab" aria-controls="software" aria-selected="false">@lang('Product')</button>
                                                    ...
                                                    <button class="nav-link" id="blog-tab" data-bs-toggle="tab" data-bs-target="#blog" type="button"
                                                        role="tab" aria-controls="blog" aria-selected="false">@lang('Blog')</button>
                                                </div>
                                            </nav>
                                            <div class="tab-content" id="nav-tabContent">
                                                                ...
                                                                <div class="item-card-content-top">
                                                                    ...
                                                                    <div class="right">
                                                                        <div class="item-amount">
                                                                            {{$code['currency']}}{{showAmount($service->price*$code['rate'])}}</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="item-card">
                                                            ...
                                                            <div class="item-card-content">
                                                                <div class="item-card-content-top">
                                                                    ...
                                                                    <div class="right">
                                                                        <div class="item-amount">
                                                                            {{$code['currency']}}{{showAmount($software->amount*$code['rate'])}}</div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="item-card">
                                                            ...
                                                            <div class="item-card-content">
                                                                <div class="item-card-content-top">
                                                                    ...
                                                                    <div class="right">
                                                                        <div class="item-amount"> {{$code['currency']}}{{showAmount($job->amount*$code['rate'])}}
                                                                            </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="tab-pane fade" id="blog" role="tabpanel" aria-labelledby="blog-tab">
                                                    <div class="item-card-wrapper border-0 p-0 grid-view mt-30" id="viewMoreBlog">
