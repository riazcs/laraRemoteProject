                                    ...
                                    <div class="blog-item-area">
                                        <div class="blog-item">
                                            ...
                                            <div class="blog-user-profile">
                                                <div class="item-card-content-top" style="margin-top:0px;">
                                                    <div class="left"></div>
                                                    <div class="right">
                                                        ...
                                                        <div class="author-content">
                                                            <h5 class="name"><a href="{{route('profile', $username)}}">{{__($username)}}</a> <span class="level-text"> {{__(@$blog->users->rank->level)}}</span></h5>
                                                        </div>
                                                    </div>
                                                </div>
