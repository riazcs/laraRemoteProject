                ...
                <div class="col-lg-12">
                    <ul class="short-menu">
                        ...
                        @foreach ($categorys->take(8) as $category)
                            <li><a
                                    href="{{ route('job.category', [slug($category->name), $category->id]) }}">{{ __($category->name) }}</a>
                            </li>
                        @endforeach
                        ...
                        <div class="item-section">
                            <div class="container">
                                <div class="item-top-area d-flex flex-wrap justify-content-between align-items-center">
                                    <div class="item-wrapper d-flex flex-wrap justify-content-between align-items-center">
                                        {{-- <div class="item-wrapper-left d-flex flex-wrap align-items-center">
                                            <div class="item-value">
                                                <span>@lang('Showing page'):&nbsp <span class="result">{{ $jobs->firstItem() }}
                                                        @lang('of') {{ $jobs->lastItem() }}</span></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item-wrapper ms-auto me-auto">
