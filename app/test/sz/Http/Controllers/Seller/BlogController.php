...
class BlogController extends Controller
{
    ...
    public function create()
    {
        ...
        return view($this->activeTemplate . 'user.seller.blog.create', compact('section','categories', 'key', 'pageTitle'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($type == 'data') {
            ...
            if ($request->hasFile('image_input')) {
                try {
                    $inputContentValue['image'] = uploadImage($request->image_input,imagePath()['blog']['path'], imagePath()['blog']['size'], @$content->data_values->image);
                } catch (\Exception $exp) {
    ...
    public function edit($id)
    {
        ...
        return view($this->activeTemplate . 'user.seller.blog.edit', compact('section','sub_categories','categories', 'key', 'pageTitle', 'data'));
