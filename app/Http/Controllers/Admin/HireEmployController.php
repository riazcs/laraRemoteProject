...
class HireEmployController extends Controller
{
    ...
    public function details($id)
    {
        ...
        $booking =Booking::with(['user', 'biding'])->where('id', $id)->where('status', '!=', '0')->whereNotNull('job_biding_id')->firstOrFail(); 
        //Booking::where('id', $id)->where('status', '!=', '0')->whereNotNull('job_biding_id')->firstOrFail();
