...
class JobController extends Controller
{
    ...
    public function create()
    {
        ...
        $categories = Category::where('type', 3)->where('status', 1)->orderby('id', 'DESC')->inRandomOrder()->get();
    	return view($this->activeTemplate . 'user.buyer.job.create', compact('pageTitle','categories'));
    }
    ...
    public function edit($slug, $id)
    {
    	...
    	return view($this->activeTemplate . 'user.buyer.job.edit', compact('pageTitle', 'job','categories')); 
    }
